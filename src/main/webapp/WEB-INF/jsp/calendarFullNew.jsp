        ...
        <s:if test="hasData()">
          <div class="data-cell">
            <a href="#" class="" onclick="return popwit('<s:property value='#application.url' />timeBlock?id=<s:property value='id' />','timeBlock');">
              ...
              <a href="<s:property value='#application.url' />timeBlock?id=<s:property value='id' />&action=Delete" class="delete-time-confirm" onclick="return confirm('Are you sure you want to delete this time block?')">
