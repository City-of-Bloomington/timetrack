...
<div class="internal-page">
	...
	<div class="width-one-half">
		...
		<s:select name="accrualWarning.accrual_id" value="%{accrualWarning.accrual_id}" list="accruals" listKey="id" listValue="name" headerKey="-1" headerValue="Pick Related Accrual" onchange="doRefresh()" />
	    </div>	    
	    <div class="form-group">
		<label>Related Earn Code(s)</label>
