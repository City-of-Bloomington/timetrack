			...
			<td align="center">
				<table width="90%" border="0">
					<tr>
						...
						<td align="left" class="td_text">&nbsp;&nbsp;<s:select name="report.department_id" value="%{report.department_id}" list="departments" listKey="id" listValue="name" headerKey="-1" headerValue="Pick Department" /></td>
					</tr>
					<tr>
