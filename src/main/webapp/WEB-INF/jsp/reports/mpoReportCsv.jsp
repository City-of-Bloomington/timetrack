...
"Hours Classified by Employeee, Date, Hour Codes",,,
Employee,Date,Hour Code,Hours
<s:iterator var="row" value="#dailyEntries"><s:property value="#row.fullname" />,<s:property value="#row.date" />,<s:property value="#row.code" />,<s:property value="#row.hoursStr" /></s:iterator>
