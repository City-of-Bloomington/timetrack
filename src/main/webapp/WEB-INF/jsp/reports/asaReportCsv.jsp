...
Employee,Employee Number,Date,Earn Code,Hours,Amount
<s:iterator var="row" value="#dailyEntries"><s:property value="#row.fullname" /> ,<s:property value="#row.empNum" />,<s:property value="#row.date" />,<s:property value="#row.code" />,<s:property value="#row.hoursStr" />,<s:property value="#row.amountPayStr" />
</s:iterator>
