...
<div class="internal-page">
  <s:form action="hourcodeCondition" id="form_id" method="post">
	...
	<div class="form-group">
	    ...
	    <s:select name="hourcodeCondition.department_id" value="%{hourcodeCondition.department_id}" list="departments" listKey="id" listValue="name" headerKey="-1" id="department_id_change" headerValue="All" />
	</div>
	<s:if test="hourcodeCondition.id != ''">
	    <div class="form-group">
		<label>Group</label>
