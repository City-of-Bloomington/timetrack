		...
		<tr><td align="center">
			<table width="90%" border="0">
				<tr>
					...
					<td align="right" class="td_text"><a href="<s:property value='#application.url' />timewarp.action?pay_period_id=<s:property value='currentPayPeriod.id' />">Current Pay Period</a></td>
				</tr>
				<tr>
