 ...
 *
	...
	<s:hidden name="action2" id="action2" value="" />
		...
		<div class="tbl_wheat">
			...
			<s:if test="timeBlock.hourCode.record_method == 'Time'">
				...
				<tr id="div_overnight"><td class="th_text">&nbsp;</td><td class="td_text"><s:checkbox name="timeBlock.overnight" value="%{timeBlock.overnight}" tabindex="4" id="time_overnight" /> Overnight Shift </td></tr>					
				<tr id="div_hours" style="display:none"><td class="th_text">Hours</td><td class="td_text"><s:textfield name="timeBlock.hours" value="%{timeBlock.hours}" size="5" maxlength="5" id="hour_change" tabindex="-1" />(dd.dd)</td></tr>
			</s:if>
			<s:else>
				...
				<tr id="div_overnight" style="display:none"><td class="th_text">&nbsp;</td><td class="td_text"><s:checkbox name="timeBlock.overnight" value="%{timeBlock.overnight}" tabindex="4" id="time_overnight" /> Overnight Shift </td></tr>			
				<tr id="div_hours"><td class="th_text">Hours</td><td class="td_text"><s:textfield name="timeBlock.hours" value="%{timeBlock.hours}" size="5" maxlength="5" id="hour_change" tabindex="5" />(dd.dd)</td></tr>
			</s:else>
			<tr><td colspan="2" class="th_text">Repeat for the next <s:textfield name="timeBlock.repeat_count" value="%{timeBlock.repeat_count}" size="2" maxlength="2" tabindex="6" /> days</td></tr>
			<tr><td class="th_text">&nbsp;</td><td class="td_text"><s:checkbox name="timeBlock.include_weekends" value="%{timeBlock.include_weekends}" tabindex="7" /> Include Weekend</td></tr>	
		</table>
		</div>
		<s:if test="timeBlock.id == ''">
	...
	<s href="#" onclick="javascript:window.close()" tabindex="10">Close</a>
