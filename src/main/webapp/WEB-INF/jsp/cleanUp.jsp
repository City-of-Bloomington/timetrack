...
<div class="internal-page">
  ...
  <s:form action="cleanUp" id="form_id" method="post">
      ...
      If the employee moved to another job then you can add job ID for the job that is terminated only. You may leave empty if the employee is terminated from all jobs or has only one job. <br />
	  ...
	  <div class="form-group">
	      <label>Job ID:</label>
	      <s:textfield name="job_id" value="%{job_id}" size="10" id="job_id" />(optional, useful when multiple jobs)
	  </div>	      
