...
public class ExcessAccrualScheduler {

    static boolean debug = false;
    static Logger logger = LogManager.getLogger(ExcessAccrualScheduler.class);
    int month = 1, day = 10, year=2025; // first Friday in the first week of PP
    Date startDate, endDate = null;
    
    public ExcessAccrualScheduler(){
	try{
	    /**
	    if(!date.isEmpty()){
	...
	try{
	    String jobName = "excess_accrual_"+month+"_"+day+"_"+year;
	    String groupName = "excess_accrual";
	    JobDetail job = JobBuilder.newJob(ExcessAccrualJob.class)
