...
public class BenefitGroup{
    ...
    public boolean isPartTimeOnly(){ // no benefit
	return partTime;
    }    
    public boolean isPartTimeExempt(){ // not needed anymore
	return partTimeEx;
    }
    public boolean isPartTimeNonExempt(){
	return partTimeNonEx;
    }    
	...
	return !temporary && !seasonal && !partTime; 
    }
    public boolean overTimeElegible(){ // not sure
	return tempWithBen || afscme || isNonExempt(); 
    }
	...
	else if(name.indexOf("FULLnx") > -1){
	    salary_group_name = "Non-Exempt";
	    nonExempt = true;
	    fullTime = true;
	}
	else if(name.indexOf("FULLx") > -1){
	    salary_group_name = "Exempt";
	    exempt = true;
	    fullTime = true;
	}
		
	else if(name.indexOf("RFTnx") > -1){
	    salary_group_name = "Non-Exempt";
	    nonExempt = true;
	    fullTime = true;
	}
	else if(name.indexOf("PARTnx") > -1){
	    salary_group_name = "Part Time Non-Exempt";
	    nonExempt = true;
	}
	else if(name.indexOf("PTnx") > -1){
	    salary_group_name = "Part Time"; //no benefit
	}
	else if(name.indexOf("LPT") > -1){
	    salary_group_name = "Part Time"; //no benefit
	}
	else if(name.indexOf("PT NX") > -1){
	    salary_group_name = "Part Time"; //no benefit
	}	
	else if(name.indexOf("PARTx") > -1){
	    salary_group_name = "Part Time Exempt";
	    exempt = true;
	}
	else if(name.indexOf("RPTx") > -1){
	    salary_group_name = "Part Time Exempt";
	    exempt = true;
	}	
	else if(name.indexOf("PTnx") > -1){
	...
	else if(name.indexOf("SWORN DET") > -1){
	...
	else if(name.indexOf("SWORN 5X8") > -1){
	    fireSworn5to8 = true;
	    fullTime = true;
	    fire = true;
	...
	else if(name.indexOf("SEASON") > -1){ // added
	    seasonal = true;
	    salary_group_name = "Seasonal";
	}
	else if(name.indexOf("COUNCIL") > -1){
	    // ignore
	}
	else if(name.indexOf("BOARD") > -1){
	    // ignore
	}
	else if(name.indexOf("ELECTED") > -1){
	    // ignore
	}
	else{
