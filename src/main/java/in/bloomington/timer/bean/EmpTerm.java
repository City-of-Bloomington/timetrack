...
public class EmpTerm{
    ...
    static Logger logger = LogManager.getLogger(EmpTerm.class);
    ...
    public EmpTerm(String val){
	//
	setId(val);
    }		
    public EmpTerm(String val, String val2){
	//
	setId(val);
	setExpire_date(val2);
    }
	...
	if(obj instanceof EmpTerm){
	    EmpTerm one =(EmpTerm)obj;
