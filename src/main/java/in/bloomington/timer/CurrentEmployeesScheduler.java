...
public class CurrentEmployeesScheduler {

		static boolean debug = false;
		static Logger logger = LogManager.getLogger(CurrentEmployeesScheduler.class);
		EnvBean envBean = null;
		int month = 1, day = 7, year=2017;
		String date = "";
		Date startDate, endDate = null;
		public CurrentEmployeesScheduler(EnvBean val, String val2){
				if(val  != null)
						envBean = val;
				if(val2 != null)
						date = val2;
        ...
        // define the job and tie it to our Job class
				try{
						String jobName = "emps_"+month+"_"+day+"_"+year;
						String groupName = "emps";
						JobDetail job = JobBuilder.newJob(CurrentEmployeesJob.class)
