...
public class EmpNoNumScheduler {

    static boolean debug = false;
    static Logger logger = LogManager.getLogger(EmpNoNumScheduler.class);
    int month = 9, day = 27, year=2026; // first run on Sunday morning
    Date startDate, endDate = null;
    public EmpNoNumScheduler(String date){
	try{
	...
	try{
	    String jobName = "emp_no_num_"+month+"_"+day+"_"+year;
	    String groupName = "emp_no_num";
	    JobDetail job = JobBuilder.newJob(EmpNoNumJob.class)
