...
public class TimeBlockList{
    ...
    */
	...
	try{
		...
		int order_id = rs.getInt(16); 

		String code_name = rs.getString(17); 
		String code_desc = rs.getString(18);
