...
public class LeaveRequestList{
	...
	String qq = "select t.id,t.job_id,date_format(t.start_date,'%Y-%m-%d'),date_format(t.end_date,'%Y-%m-%d'),t.hour_code_id,t.total_hours,t.request_details,t.initiated_by,date_format(t.request_date,'%m/%d/%Y'), "+
