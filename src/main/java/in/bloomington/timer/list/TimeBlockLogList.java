...
public class TimeBlockLogList{
    ...
    public String find(){
				...
				ResultSet rs = null;
				String msg="", qw="";
				String qq = "select id,document_id,hour_code_id,date_format(date,'%m/%d/%Y'),begin_hour,begin_minute,end_hour,end_minute,hours,amount,clock_in,clock_out,time_block_id,action_type,action_by_id,date_format(action_time,'%m/%d/%y %H:%i') from time_block_logs ";
