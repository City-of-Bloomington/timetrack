...
public class CodeReasonScheduler {

		static boolean debug = false;
		static Logger logger = LogManager.getLogger(CodeReasonScheduler.class);
		int month = 1, day = 1, year=2017;
		Date startDate, endDate = null;
		String outputFile = "";
		public CodeReasonScheduler(String date, String outputFile){
				try{
						...
						if(!date.isEmpty()){
								...
								cal.set(Calendar.HOUR_OF_DAY, 5);//to run at 5am of the specified day
        ...
        // define the job and tie it to our Job class
				try{
						String jobName = "code_reason_"+year+"_"+month+"_"+day;
						String groupName = "code_reason";
						JobDetail job = JobBuilder.newJob(CodeReasonJob.class)
								.withIdentity(jobName, groupName)
								.build();
						job.getJobDataMap().put("outputFile", outputFile);	
						// 
						...
						Trigger trigger = TriggerBuilder.newTrigger()
								...
								.withSchedule(simpleSchedule()
															...
															.withIntervalInHours(24) // everyday
															.repeatForever()
															// .withRepeatCount(2) 
