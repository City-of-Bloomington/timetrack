...
public class HandleNwAccrual{
	...
	*/
	...
	try{
	    ...
	    ps.setString(2, "6,8,9,15,21,18,7,16"); // sick, pto, holiday, comp, leave, vacation,Kelly leave (fire), 19=paid family medical leave 
	    ps.setInt(3,258);
		...
		if(empHash.containsKey(str2)){
		    ...
		    System.err.println("handleNwAccrual: id,emp_num,accruals "+ str+" "+str2+" "+str3+" "+ptoa+" "+scka+" "+holya+" "+cua+" "+lba+" "+vla+" "+klv+" "+pfla);
		    // sick bank
